...
- 双层注意力在 [src/modeling_blsp2.py](/Users/z786/Workspace/caes_original/src/modeling_blsp2.py)
- 语音桥接模块在 [src/modeling_adapter.py](/Users/z786/Workspace/caes_original/src/modeling_adapter.py)
- 数据结构化组织在 [src/instruction_dataset.py](/Users/z786/Workspace/caes_original/src/instruction_dataset.py)
- 训练入口在 [train.py](/Users/z786/Workspace/caes_original/train.py)
...
- [src/modeling_whisper_encoder.py](/Users/z786/Workspace/caes_original/src/modeling_whisper_encoder.py)
...
默认配置见 [src/configuration_blsp2.py](/Users/z786/Workspace/caes_original/src/configuration_blsp2.py)。
...
- [src/modeling_adapter.py](/Users/z786/Workspace/caes_original/src/modeling_adapter.py)

## 6. 双层注意力是这份代码最关键的研究实现

### 6.1 第一层：单轮内部语音注意力

在 [src/modeling_blsp2.py](/Users/z786/Workspace/caes_original/src/modeling_blsp2.py) 中，模型先对每一轮语音做压缩与 self-attention。
...
- [src/modeling_blsp2.py](/Users/z786/Workspace/caes_original/src/modeling_blsp2.py)
...
Stage 1 主要目标是先把语音桥接和语义空间对齐好。

脚本：

- [scripts/train_stage1.sh](/Users/z786/Workspace/caes_original/scripts/train_stage1.sh)
...
- [scripts/train_stage2.sh](/Users/z786/Workspace/caes_original/scripts/train_stage2.sh)

特点：

- 同时使用 `response_ce,response_kl`
- 解冻范围更大
- 目标从“能对齐”变成“能生成更符合情绪的回复”
...
这些损失的组合逻辑集中在 [src/modeling_blsp2.py](/Users/z786/Workspace/caes_original/src/modeling_blsp2.py)。
...
1. [train.py](/Users/z786/Workspace/caes_original/train.py)
2. [src/instruction_dataset.py](/Users/z786/Workspace/caes_original/src/instruction_dataset.py)
3. [src/modeling_blsp2.py](/Users/z786/Workspace/caes_original/src/modeling_blsp2.py)
4. [src/modeling_adapter.py](/Users/z786/Workspace/caes_original/src/modeling_adapter.py)
5. [generate.py](/Users/z786/Workspace/caes_original/generate.py)
